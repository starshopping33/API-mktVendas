...
namespace API_mktVendas.Application.Service
{
    ...
    {
        public async Task RegisterAsync(string nome, string cpf, string email,string telefone , string password)
        {
            ...
            await repo.AddAsync(new Usuario { Nome = nome, Cpf = cpf, Email = email, Telefone = telefone , SenhaHash = hash, ImagemBase64 = imagem64Default, IsAdmin = false });
        }
        ...
        public async Task<string> LoginAsync(string email, string password)
        {
            ...
            return GenerateToken(
                  ...
                  user.Id,user.Email,user.Cpf, user.Telefone,user.Nome,user.ImagemBase64 ,user.IsAdmin);
        }

        private string GenerateToken(int id ,string email, string cpf,string telefone,string nome, string imagebase64 ,bool isAdmin)
        {
